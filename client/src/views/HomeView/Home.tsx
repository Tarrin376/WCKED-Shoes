...
const Home: React.FC<{}> = () => {
  ...
  const getProducts = usePagination<TProductCard, TProductOptions>(orderProducts, productsLimit, "/products", location.state || "", "", searchRef);

  return (
    <>
      <div className="flex max-lg:flex-col mt-[70px] lg:justify-between lg:items-center mb-[30px] gap-5 max-md:p-3 max-md:rounded-[8px]">

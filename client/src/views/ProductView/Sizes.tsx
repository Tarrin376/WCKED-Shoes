  ...
  return (
    <div className="flex flex-wrap gap-[11px] mb-3">
      {sizes.map((cur: TSize, index) => {
        return (
          <div className={`flex select-none items-center justify-center outline outline-[1px] outline-main-text-black dark:outline-[#6F6F6F] w-[70px] h-[30px] rounded-[5px] cursor-pointer

...
const WriteReview: React.FC<Props> = ({ product }) => {
  ...
  return (
    <div className="light-component dark:gray-component 2xl:w-[35%] max-2xl:w-[40%] max-xl:w-full p-5 pt-3 relative">
      ...
      <input type="text" className="text-box-light dark:text-box w-full mb-3" maxLength={40} placeholder="Enter review heading" value={reviewTitle}
      ...
      <textarea className="text-box-light dark:text-box w-full h-[300px]" placeholder="Share your thoughts on the product" value={review}

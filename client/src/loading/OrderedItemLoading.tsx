  ...
  return (
    ...
    max-lg:gap-2 items-center ${isFirst ? "!pt-0" : ""} ${noBorder ? "!pb-0 !border-none" : ""}`}>
      ...
      <div className="pt-2 pb-2">
        <div className="w-[160px] h-[20px] loading-light dark:loading-dark"></div>
        <div className="w-[130px] h-[18px] loading-light dark:loading-dark mt-3"></div>
      ...
      <div className="flex items-center justify-end lg:gap-[150px] max-lg:gap-[70px] flex-grow">
        <div className="w-[80px] h-[20px] loading-light dark:loading-dark max-md:hidden"></div>
        <div className="w-[70px] h-[20px] loading-light dark:loading-dark mr-5"></div>
      </div>
    </div>
  )
};

...
class Order(settings.db.Model):
  id = settings.db.Column(settings.db.Integer, primary_key=True)
  user_id = settings.db.Column(settings.db.Integer, settings.db.ForeignKey('user.id'), nullable=False)
  date_ordered = settings.db.Column(settings.db.DateTime(timezone=True), default=datetime.now, nullable=False)
  processing_date = settings.db.Column(settings.db.DateTime(timezone=True))
  shipped_date = settings.db.Column(settings.db.DateTime(timezone=True))
  delivered_date = settings.db.Column(settings.db.DateTime(timezone=True))
